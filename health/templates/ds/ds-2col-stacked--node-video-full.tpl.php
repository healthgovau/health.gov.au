...
<<?php print $layout_wrapper; print $layout_attributes; ?> class="ds-2col-stacked <?php print $classes;?> clearfix">
  ...
  <<?php print $left_wrapper ?> class="group-left col-xs-12 col-sm-8<?php print $left_classes; ?>">
    <?php print $left; ?>
  </<?php print $left_wrapper ?>>

  <<?php print $right_wrapper ?> class="group-right col-xs-12 col-sm-4<?php print $right_classes; ?>">
    <?php print $right; ?>
