...
?>
<article <?php print $attributes; ?> class="<?php print $classes; ?> uikit-card-compact clearfix node-<?php print $node->nid; ?> <?php if($featured): ?>uikit-card--featured-left<?php endif; ?>">
  ...
  <div class="uikit-card-compact--content">
