...
?>
<?php if (!$label_hidden): ?>
  <h2 class="au-display-lg" <?php print $title_attributes; ?>><?php print $label ?></h2>
<?php endif; ?>

<div class="au-callout au-callout--tertiary au-callout--thin <?php print $classes; ?>"<?php print $attributes; ?>>
  <?php foreach ($items as $delta => $item): ?>
    <strong><?php print render($item); ?></strong>
    <div class="external-link-url"><?php print $item['#element']['url']; ?></div>
  <?php endforeach; ?>
</div>
