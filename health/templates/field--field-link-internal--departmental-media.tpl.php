...
<div class="<?php print $classes; ?>"<?php print $attributes; ?>>
  ...
  <div class="field-items"<?php print $content_attributes; ?>>
    <?php foreach ($items as $delta => $item): ?>
      <div class="field-item <?php print $delta % 2 ? 'odd' : 'even'; ?>"<?php print $item_attributes[$delta]; ?>><?php print render($item); ?><div class="external-link-url"><?php global $base_url; print $base_url . '/' . drupal_get_path_alias($item['#element']['url']); ?></div></div>
    <?php endforeach; ?>
  </div>
</div>
